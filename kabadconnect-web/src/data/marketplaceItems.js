export const INITIAL_MARKETPLACE_ITEMS = [
  ...
  // 8. Bicycle / Mountain Cycle (User requested)
  {
    id: 'mkt-cycle-1',
  ...
  // 9. Old Bicycle / Classic Roadster (User requested)
  {
    id: 'mkt-cycle-2',
  ...
  // 10. Table (Center Table) (User requested)
  {
    id: 'mkt-table-1',
...
export const MARKETPLACE_CATEGORIES = [
  { id: 'all', label: 'All Items', icon: 'Sparkles', count: 14 },
  { id: 'furniture', label: 'Furniture (Almirah, Sofa, Bed, Tables)', icon: 'Armchair', count: 6 },
  { id: 'appliances', label: 'Home Appliances (AC, Fridge)', icon: 'Tv', count: 1 },
  { id: 'cycles', label: 'Cycles & Bicycles', icon: 'Bike', count: 2 },
  { id: 'upcycled', label: 'Eco Upcycled Crafts', icon: 'Leaf', count: 4 }
];

export const PRODUCT_SUBCATEGORY_PRESETS = [
  {
    id: 'almirah',
